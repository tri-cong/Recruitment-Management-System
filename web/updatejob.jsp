                                ...
                                <div class="row justify-content-center">
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company" name="nameJob" value="${updatejob.nameJob}" class="form-control" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="select" class="form-control-label">Nhóm công việc</label>
                                            <select name="cateID" id="select" class="form-control" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="workplace" id="select" class="form-control" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="degree" id="select" class="form-control" required="">
                                                <option>--Lựa chọn--</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="experience" id="select" class="form-control" required="">
                                                <option>--Lựa chọn--</option>
                                        ...
                                        <div class="form-group">
                                            <label for="select" class="form-control-label">Số lượng cần tuyển </label>
                                            <input name="quantity" type="text" id="company" value="${updatejob.quantity}" class="form-control" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="select" class="form-control-label">Thời hạn nhận hồ sơ</label>
                                            <input name="applieddate" type="text" id="company" value="${updatejob.applieddate}" class="form-control" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="centered" class="form-control-label">Mô tả công việc</label>
                                            <input name="jobDesciption" type="text" id="company" value="${updatejob.jobDesciption}" class="form-control" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="centered" class="form-control-label">Yêu cầu công việc</label>
                                            <input name="jobRequest" type="text" id="company" value="${updatejob.jobRequest}" class="form-control" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="centered" class="form-control-label">Quyền lợi</label>
                                            <input name="rights" type="text" id="company" value="${updatejob.rights}" class="form-control" required="">
                                        </div>
                                        <div class="form-group text-center">
                                            <input type="submit" class="btn btn-primary btn-lg active" value="Cập nhật">
                                            <input type="hidden" name="idJob" value="${updatejob.idJob}">
                                        </div>
                                    </div>
