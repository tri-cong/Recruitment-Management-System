<%-- 
    Document   : open
    Created on : Jul 21, 2022, 8:45:43 PM
    Author     : HI
--%>
                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="overview-wrap">
                                        <h2 class="title-1">Lập trình viên Java</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row" style="margin-top:50px;">
                                <div class="col-3" id="card-apply">
                                    <div class="card-header user-header border">
                                        <div class="media">
                                            <a href="#">
                                                <img class="align-self-center rounded-circle mr-3"
                                                     style="width:50px; height:50px;" alt="" src="images/icon/avatar-01.jpg">
                                            </a>
