<%-- 
    Document   : Screencv
    Created on : Jul 18, 2022, 8:45:29 PM
    Author     : HI
--%>
                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="col-md-12">
                                        <ul class="nav nav-pills nav-justified">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="screencv?id=${sessionScope.id.idApplicant}">CV</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <img src="images/icon/${screencv.img}" width="1000px" height="1500px"/>
                            </div>
                        </div>
                    </div>
                </div>
