<%-- 
    Document   : home
    Created on : Jul 15, 2022, 12:43:25 PM
    Author     : HI
--%>
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="home.jsp">
                            <img src="assets/img/logo/logo3.png" alt="CoolAdmin" />
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="home.jsp">
                    <img src="assets/img/logo/logo3.png" alt="Cool Admin" />
                </a>
            </div>
                        ...
                        <div class="row" id="home-title">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Danh sách tin tuyển dụng</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8">
                                <div class="row" style="margin-bottom:50px ;">
                                    <div class="col-md-2 align-items-center" id="border-item-1"
                                        style="text-align: center ;">
                                        <p style="padding-top: 50%;">31</p>
                                        <p>ỨNG VIÊN</p>
                                        <button class="btn btn-group-sm btn-primary">JOB</button>
                                    </div>
                            ...
                            <div class="col-4 border">
                                <div class="row">
                                    <div class="col">
                                        <h4 style="padding-top:25px ;">Thông kê ứng viên</h4>
                                ...
                                <div class="row" style="margin-top: 50px;">
                                    <div class="col">
                                        <h4>Ứng viên mới apply gần đây</h4>
                                        <div class="card-header user-header border" style="margin-top: 20px;">
                                            <div class="media">
                                                <a href="#">
                                                ...
                                                <div class="media-body">
                                                    <h3 class="display-6">Duy Nguyễn</h3>
                                                    <p>0394167409</p>
